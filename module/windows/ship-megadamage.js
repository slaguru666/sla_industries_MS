...
export class DLShipMegaDamage extends FormApplication {
    static get defaultOptions() {
        ...
        options.template = 'systems/sla-mothership/templates/dialogs/ship-megadamage-dialog.html';
        options.width = 320;
        options.height = 'auto';
    ...
    async _prepareMegadamage(sheetData){
        ...
        let tableId = game.settings.get('sla-mothership','table1eMegadamageEffects');
        //get table data
