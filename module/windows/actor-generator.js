export class DLActorGenerator extends FormApplication {
   static get defaultOptions() {
      ...
      options.template = 'systems/sla-mothership/templates/dialogs/actor-generator-dialog.html';
      options.width = 800;
      options.height = "auto";
   ...
   async popUpSkillOptions(skillPopupOptions) {
      ...
      for (let i = 0; i < skillPopupOptions.master_full_set; i++) {
         await this.showSkillDialog('systems/sla-mothership/templates/dialogs/actor-generator/actor-generator-skill-option-full-master-dialog.html');

      }
      for (let i = 0; i < skillPopupOptions.expert_full_set; i++) {
         await this.showSkillDialog('systems/sla-mothership/templates/dialogs/actor-generator/actor-generator-skill-option-full-expert-dialog.html');

      }
      for (let i = 0; i < skillPopupOptions.trained; i++) {
         await this.showSkillDialog('systems/sla-mothership/templates/dialogs/actor-generator/actor-generator-skill-option-single-dialog.html', "Trained");

      }
      for (let i = 0; i < skillPopupOptions.expert; i++) {
         await this.showSkillDialog('systems/sla-mothership/templates/dialogs/actor-generator/actor-generator-skill-option-single-dialog.html', "Expert");

      }
      for (let i = 0; i < skillPopupOptions.master; i++) {
         await this.showSkillDialog('systems/sla-mothership/templates/dialogs/actor-generator/actor-generator-skill-option-single-dialog.html', "Master");
   ...
   async showOptionsDialog(list_option_skills_or) {
      ...
      let popUpContent = await foundry.applications.handlebars.renderTemplate("systems/sla-mothership/templates/dialogs/actor-generator/actor-generator-skill-option-choice-dialog.html", popupData);
